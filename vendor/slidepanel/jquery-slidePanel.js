...
(
  ...
  function(_jquery) {
      ...
      _createClass(Drag, [{
        ...
        value: function onDragStart(event) {
          ...
          if (options.mouseDrag) {
            ...
            $(document).one(SlidePanel.eventName('mousemove'), $.proxy(
          ...
          if (options.touchDrag && Support.touch) {
            ...
            $(document).one(SlidePanel.eventName('touchmove'), $.proxy(
          ...
          if (options.pointerDrag && Support.pointer) {
            ...
            $(document).one(SlidePanel.eventName(Support.prefixPointerEvent('pointermove')), $.proxy(
      ...
      _createClass(View, [{
        ...
        value: function load(object) {
          ...
          var setContent = function setContent(content) {
            content = options.contentFilter.call(_this, content, object);
            _this.$content.html(content);
            _this.hideLoading();

            _this._instance = object;

            SlidePanel.trigger(_this, 'afterLoad', object);
          };
          ...
          if (object.content) {
            ...
            $.ajax(object.url, object.settings || {}).done(setContent);
          } else {
            setContent('');
          }
        }
    ...
    var OtherSlidePanel = $.fn.slidePanel;
