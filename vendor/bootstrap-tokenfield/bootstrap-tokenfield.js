  ...
  * ============================== */
  ...
  , update: function (e) {
      ...
      if (this.$input.data('edit')) {
        ...
        this.$input.width( mirrorWidth - 2 )

        if (this.$hint) {
          this.$hint.width( mirrorWidth - 2 )
        }
      }
      else {
        ...
        isNaN(w) ? this.$input.width('99%') : this.$input.width(w - 2);

        if (this.$hint) {
          isNaN(w) ? this.$hint.width('99%') : this.$hint.width(w - 2);
        }
      }
    }
